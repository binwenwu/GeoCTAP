<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"
      ...
      <el-table-column prop="score" label="活动经费"></el-table-column>
      <el-table-column prop="times" label="志愿时长"></el-table-column>
      <el-table-column prop="teacher" label="负责人"></el-table-column>
      ...
      <el-table-column label="操作" width="280" align="center">
        <template slot-scope="scope">
          <el-button type="primary" @click="selectCourse(scope.row.id)">报名</el-button>
    ...
    <el-dialog title="志愿活动信息" :visible.sync="dialogFormVisible" width="30%" >
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      this.request.get("/user/role/ROLE_CHARGE").then(res => {
